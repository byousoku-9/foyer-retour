...
def test_defaults_match_spine_hypotheses() -> None:
    ...
    assert s.max_cost_eur_per_request == 3.50 and s.cost_alert_eur == 1.00
    ...
    assert s.evals_max_cost_eur == 60.0 and s.live_budget_eur == 60.0
...
def test_thresholds_feed_trace(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    assert t.thresholds["max_cost_eur_per_request"] == 3.50
