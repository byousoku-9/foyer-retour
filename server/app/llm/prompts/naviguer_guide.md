...
- `ouvrir_noeud(node_id, facette)` — le **texte intégral** des blocs citables du nœud et de ses enfants
  ...
  se rattache aux sous-questions, et c'est la seule chose qui distingue « le guide ne traite pas
  cette sous-question » de « personne n'a ouvert la fiche qui la traite ». Une ouverture, une
