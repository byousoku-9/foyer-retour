...
class ClarificationRequise(DomainModel):
    ...
    def langue_affirmee(self) -> bool:
        ...
        *restituer*), et le prompt la lui demande « dans la langue de la question ». Quand la langue
        ...
        titre même d'AD-5 (« après un **seul** appel de *comprendre* », « c'est le seul appel modèle
        avant le court-circuit »), et une consigne ajoutée à *chaque* requête a été mesurée le 2026-08-25
